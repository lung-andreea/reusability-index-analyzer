...
class SampleProjectsDataModel:
    ...
    def construct_sample_projects_dataframes(self, sample_projects_dir):
        ...
        for filename in os.listdir(class_results_dir):
            ...
            enhanced_df = self.get_enhanced_class_dataframe(class_filepath, method_filepath)
